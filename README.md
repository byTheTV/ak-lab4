...
Нормативное ТЗ: [lab4-task.md](lab4-task.md). Структура отчёта — по разделам из ТЗ; по **оформлению и полноте** ориентиры: [rmntim/csa-lab4](https://github.com/rmntim/csa-lab4/blob/8b7cb5c146b00feff59942a186185bf1075bfeed/README.md), [maxbarsukov/csa3-stack-machine](https://github.com/maxbarsukov/csa3-stack-machine/blob/d252239e91fb885dfcd35da1517ea5be302777c4/README.md), пример курса [ryukzak/brainfuck — python/README.md](https://github.com/ryukzak/brainfuck/blob/master/python/README.md).
...
symbol    ::= печатный символ, не пробел и не одна из: ( ) " ;
```
