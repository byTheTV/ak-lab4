...
Для соответствия требованиям методички golden-артефакты вынесены в отдельный файл [golden/ARTIFACTS.md](golden/ARTIFACTS.md): для каждого кейса приведены репрезентативные фрагменты машинного кода, сегмента данных и журнала исполнения.
...
Если указан `--log`, симулятор пишет потактовый журнал (ticks, pc/PAR, слово команды, контекст USR/ISR).
